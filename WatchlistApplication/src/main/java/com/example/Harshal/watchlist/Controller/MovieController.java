package com.example.Harshal.watchlist.Controller;
...
import com.example.Harshal.watchlist.Service.DatabaseService;
...
public class MovieController {
	...
	public ModelAndView submitWatchListForm(@Valid @ModelAttribute("watchlistItem") Movie movie, BindingResult bindingResult  )  {
		...
		if(bindingResult.hasErrors()) {
			//if error occurs then redisplay the form to user
